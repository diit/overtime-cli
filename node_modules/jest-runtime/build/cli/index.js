 ...
 *
 * 
 */const VERSION = require('../../package.json').version;function run(cliArgv, cliInfo) {let argv;if (cliArgv) {argv = cliArgv;} else {argv = (_yargs || _load_yargs()).default.usage((_args || _load_args()).usage).help(false).version(false).
